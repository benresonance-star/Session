...
export function SessionList({ sessions }: { sessions: SessionDefinition[] }): JSX.Element {
  return (
    <main className="min-h-screen bg-bg text-text px-6 py-10 sm:px-10">
      <div className="mx-auto max-w-xl">
        ...
        <div className="space-y-8">
          {sessions.length === 0 ? (
            <p className="text-sm text-muted">No sessions yet. Create one in the builder and save to Supabase, or configure env to use the bundled sample.</p>
          ) : (
